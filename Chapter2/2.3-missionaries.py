...
class MCState:
    ...
    def __str__(self) -> str:
        return (
            ...
            self.wm, ('bo' + '~' * 5 if self.boat else '~' * 5 + 'bo'), self.em,
            self.wc, ('at' + '~' * 5 if self.boat else '~' * 5 + 'at'), self.ec
        )
...
def display_solution(path: List[MCState]):
    ...
    for current_state in path[1:]:
        if current_state.boat:
            print("east -> west: {} missionaries and {} cannibals\n".format(
                old_state.em - current_state.em, old_state.ec - current_state.ec))
        else:
            print("west -> east: {} missionaries and {} cannibals \n".format(
