# A Constraint Satisfaction Problem (CSP) consists of variables of type V that have ranges of values
...
# Class for solving Constraint Satisfaction Problems
class CSP(Generic[V, D]):
    ...
    # Check if the value assignment is consistent by checking all constraints for the given variable
    # against it
